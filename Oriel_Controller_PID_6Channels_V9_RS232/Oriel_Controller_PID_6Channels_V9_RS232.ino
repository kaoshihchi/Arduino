...
void setup() {
  ...
  pinMode(pinMotorMinus_ch1, OUTPUT); pinMode(pinMotorPlus_ch1, OUTPUT); pinMode(pinEncoderA_ch1, INPUT); pinMode(pinEncoderB_ch1, INPUT); pinMode(pinEn_ch1, OUTPUT);
  ...
  pinMode(pinMotorMinus_ch3, OUTPUT); pinMode(pinMotorPlus_ch3, OUTPUT); pinMode(pinEncoderA_ch3, INPUT); pinMode(pinEncoderB_ch3, INPUT); pinMode(pinEn_ch3, OUTPUT);
  ...
  pinMode(pinMotorMinus_ch5, OUTPUT); pinMode(pinMotorPlus_ch5, OUTPUT); pinMode(pinEncoderA_ch5, INPUT); pinMode(pinEncoderB_ch5, INPUT); pinMode(pinEn_ch5, OUTPUT);
  ...
  minPWM = 90;       // INCREASED Stiction compensation for reliability
}
